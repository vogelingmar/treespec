...
def mock_classification_config():
    return SimpleNamespace(
        train=SimpleNamespace(
            ...
            trained_model_dir=classification_mock_temp_dir_path,
            train_augmentations=[
        ...
        predict=SimpleNamespace(
            tree_images_dir="/test_path/mock",
            input_inventory_path="/test_path/mock",
            output_inventory_path="/test_path/mock",
            trained_model_path="/test_path/mock",
        ),
    )
...
def test_train_config_values(mock_classification_config):
    ...
    assert isinstance(config_parser.train_config_values("dataset_dir", mock_classification_config), str)
    ...
    assert isinstance(config_parser.train_config_values("trained_model_dir", mock_classification_config), str)


def test_predict_config_values(mock_classification_config):
    assert isinstance(config_parser.predict_config_values("tree_images_dir", mock_classification_config), str)
    assert isinstance(config_parser.predict_config_values("input_inventory_path", mock_classification_config), str)
    assert isinstance(config_parser.predict_config_values("output_inventory_path", mock_classification_config), str)
    assert isinstance(config_parser.predict_config_values("trained_model_path", mock_classification_config), str)
