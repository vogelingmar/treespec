""" "Tests for the dataset creation functions."""
...
def test_create_dataset():
    ...
    for tree_attribute in tree_attributes:
        ...
        if number_of_found_trees == 0:
            ...
            ), "Number of images in output datasets do not match!"
...
def test_create_big_scale_dataset():
    ...
    input_dir_path = Path(os.path.join(dataset_creation_mock_path, "large_scale_dataset_creation_input"))
    output_dir_path = Path(os.path.join(dataset_creation_mock_path, "temp", "large_scale_dataset"))
